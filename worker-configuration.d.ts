/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: eef4c87cdea202cc598f1d9db8fa6062)
// Runtime types generated with workerd@1.20260722.1 2026-06-16 
interface __BaseEnv_Env {
	...
	DEFAULT_P2P_TRANSFER: boolean;
	DEFAULT_P2P_EXPIRATION: string;
	MAX_P2P_EXPIRATION: string;
	DEFAULT_P2P_TRANSFERS: number;
	DEFAULT_P2P_VERIFY: boolean;
	TURN_URLS: string[];
	P2P_ROOM: DurableObjectNamespace<import("./worker/index").P2PRoom>;
	PASTE_READ_COUNTER: DurableObjectNamespace<import("./worker/index").PasteReadCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "P2PRoom" | "PasteReadCounter";
	}
